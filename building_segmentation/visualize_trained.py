...
def save_batch_images(source, seg_predictions, seg_labels,reg_labels,out_dir,ctr):
...
def main():
    ...
    with torch.no_grad():
        for i, data in enumerate(data_loader, 0):
            ...
            save_batch_images(image, seg_predictions, seg_labels,reg_labels, full_dir_name, i)
