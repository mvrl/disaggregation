...
if __name__ == "__main__":
  ...
  #image size defininition
  image_width = 302
  delta_X = image_width / 2

  #Bounds
  X_min_bound = 440000  #Measured in meters
  X_max_bound = 473000
  Y_min_bound = 4973000
  Y_max_bound = 4988000
  ...
  if __name__ == '__main__':
    ...
    #template_url = 'http://kyraster.ky.gov/arcgis/services/ImageServices/Ky_NAIP_2014_1M/ImageServer/WMSServer?request=GetMap&service=WMS&layers=0&CRS=EPSG:4326&BBOX={:},{:},{:},{:}&width=302&height=302&format=image/jpeg'
    template_url = 'https://gis.hennepin.us/arcgis/services/Imagery/UTM_Aerial_2020/MapServer/WMSServer?version=1.3.0&&service=WMS&request=GetMap&&styles=&layers=0&CRS=EPSG:26915&BBOX={:},{:},{:},{:}&width=604&height=604&format=image/png'
    ...
    for idx, row in tqdm(df.iterrows(), total=len(df)):
      ...
      print(image_url)
      out_file = 'downloads/' + "{:}/{:}/{:.6f}_{:.6f}.jpg".format(
          int(float(row['lat_mid'])), int(float(row['lon_mid'])),
